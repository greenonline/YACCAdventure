...
%token TOKGIVE TOKGOLD TOKAND TOKTHEN TOKKEY TOKTHORIN TOKTO TOKHEAT TOKTARGET TOKTEMPERATURE
%token TOKSTAB TOKDEATH
...
commands: /* empty */
| commands command
| commands TOKAND command
| commands TOKTHEN command
| commands TOKAND TOKTHEN command
;
